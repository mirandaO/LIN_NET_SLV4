...
extern enum E_PORT
{
	LED_BAR_0,  /*Port A, Pin 0.  Functions: GPIO[0], E0UC[0], CLKOUT, E0UC[13] and WKPU[19]^5              */
	LED_BAR_1,  /*Port A, Pin 1.  Functions: GPIO[1], E0UC[1], NMI^6 and WKPU[2]^5                          */
	LED_BAR_2,  /*Port A, Pin 2.  Functions: GPIO[2], E0UC[2], MA[2] and WKPU[3]^5                          */
	LED_BAR_3,  /*Port A, Pin 3.  Functions: GPIO[3], E0UC[3], LIN5TX, CS4_1, EIRQ[0] and ADC1_S[0]         */
	LED_BAR_4,  /*Port A, Pin 4.  Functions: GPIO[4], E0UC[4], CS0_1, LIN5RX and WKPU[9]^5                  */
	LED_BAR_5,  /*Port A, Pin 5.  Functions: GPIO[5], E0UC[5] and LIN4TX                                    */
	LED_BAR_6,  /*Port A, Pin 6.  Functions: GPIO[6], E0UC[6], CS1_1, EIRQ[1] and LIN4RX                    */
	LED_BAR_7,  /*Port A, Pin 7.  Functions: GPIO[7], E0UC[7], LIN3TX, EIRQ[2] and ADC1_S[2]                */
	LED_BAR_8,  /*Port A, Pin 8.  Functions: GPIO[8], E0UC[8], E0UC[14], EIRQ[3], ABS[0] and LIN3RX         */
	LED_BAR_9,  /*Port A, Pin 9.  Functions: GPIO[9], E0UC[9], CS2_1 and FAB                                */
	LED_DOWN,  /*Port A, Pin 10. Functions: GPIO[10], E0UC[10], SDA, LIN2TX and ADC1_S[2]                   */
	LED_UP,  /*Port A, Pin 11. Functions: GPIO[11], E0UC[11], SCL, EIRQ[16], LIN2RX and ADC1_S[3]           */
	PA12,
	...
	PB02,  /*Port B, Pin 2.  Functions: GPIO[18], LIN0TX, SDA and E0UC[30]                                  */
	PB03,  /*Port B, Pin 3.  Functions: GPIO[19], E0UC[31], SCL, WKPU[11]^5 and LIN0RX                      */
